...
# Part 2: Map Visualizations for Cook County Homicides, 1874-1930 and 1965-2016
...
![**Animation of Homicides per Hexagon by Year 1965-2014**](hex_map_list_after.gif)
...
![**Animation of Homicides per Hexagon by Year 1874-2014**](hex_map_list_all.gif)
...
# Part 3: Time Series Line Graph for Annexed and Non-Annexed Community Areas

A time series line graph is made to show the total number of homicides per year in annexed and non-annexed Community Areas.

```{r pt3_time_series_line_graph, results=FALSE, message=FALSE, warning=FALSE}
...
This will be more meaningful once building data are used as a denominator, after which a rate of homicides over building density will be used instead.
